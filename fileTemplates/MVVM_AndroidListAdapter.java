...
public final class ${NAME} extends AbstractBindingAdapter<${DATA_TYPE}, ${VIEW_HOLDER_TYPE}> {
  ...
  @Override protected void bindDataViewHolder(${DATA_TYPE} item, ${VIEW_HOLDER_TYPE} viewHolder, int position) {
    viewHolder.setItem(${BR_ITEM_NAME}, item, position);
  }
